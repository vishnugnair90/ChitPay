...
- (instancetype)initWithImages:(NSArray *)images selectedIndices:(NSIndexSet *)selectedIndices borderColors:(NSArray *)colors titleTexts:(NSArray *)titles
{
    if (self = [super init]) {
        _isSingleSelect = NO;
        ...
        [_images enumerateObjectsUsingBlock:^(UIImage *image, NSUInteger idx, BOOL *stop) {
            ...
            view.label.text = [_titles objectAtIndex:idx];
            view.label.font = [UIFont systemFontOfSize:10.0];
